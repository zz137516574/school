...
<template>
  <div class="creatingCourses clearfix">
    ...
    <div class="content">
      ...
      <!--<p class='name' ref="name">文件名称<p/>-->
      <!--<label for="upload">选择上传文件</label>-->
      <!--<input type="file" id="upload" style='display:none;' ref="upload"/>-->
      <!--<span class='progressTxt' ref="progressTxt"></span>-->
      <!--<p class='progress-bar' ref="progress-bar"><span class="progress" ref="progress"></span></p>-->
      <!--</div>-->
    </div>
  </div>
</template>
