    ...
    <div class="freeClass">
        ...
        <div class="container clearfix classHeaderMian">
            ...
            <div class="f-fl main">
              ...
              <div class="collection" style="display: inline-block;cursor: pointer;" @click="collectEvent">
                <!--没有收藏-->
                <div style="display: inline-block">
              ...
              <!--<div class="clearfix rates">-->
                ...
                <!--</div>-->
                <div class="price">
                  <span v-if="price != 0 " style="margin-left: 0;">价格:<span v-if="price != 0" style="color: #ff8a0c;">￥{{courseDetailsData.price | currency}}</span></span>
        ...
        <!--<div class="model" style="position: fixed;left: 0;top: 0;width: 100%;height: 100%;background: rgba(0,0,0,.6);z-index: 999;" v-show="moneyMask">-->
          <!--<div style="margin: 300px auto;width: 500px;height: 300px;line-height: 300px;text-align: center;background: #ffffff">-->
            <!--<Button type="primary" size="large"   @click="ReturnLogon" style="background: #dab866;border-color: #dab866;margin-right: 15px;">&lt;&lt; 支付成功！</Button>-->
            <!--<Button type="primary" size="large"   @click="ReturnLogon" style="background: #dab866;border-color: #dab866;">&lt;&lt; 支付失败，查询帮助</Button>-->
          <!--</div>-->
        <!--</div>-->
