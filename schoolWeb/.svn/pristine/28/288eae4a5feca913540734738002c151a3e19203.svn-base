    ...
    <div class="freeClass">
        ...
        <div class="container clearfix classHeaderMian">
            ...
            <div class="f-fl main">
                ...
                <!--</div>-->
                <div class="price">
                  <span v-if="price != 0 " style="margin-left: 0;">价格:<span style="color: #ff8a0c;">￥{{courseDetailsData.price}}</span></span>
        ...
        methods: {
          courseDetailsLists(){
            this.service.courseInfo(this.seriesCourseId, this.onorsome,this.userId).then(result => {
              ...
              //课程目录
              this.courseCatalogues = result.course.courseCommentList;
              // 学员评价
